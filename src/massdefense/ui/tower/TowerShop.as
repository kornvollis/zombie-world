package massdefense.ui.tower 
{
	...
	public class TowerShop  extends Sprite
	{
		...
		private var towerButtons : Vector.<TowerShopButton> = new Vector.<TowerShopButton>;
		
		private var topArrow : Button;
		private var bottomArrow : Button;
		
		
		public function TowerShop() 
		{
		...
		private function addTowerButtons():void 
		{
			for (var row:int = 0; row < ROW; row++) 
			{
				...
				{
					var towerButton : TowerShopButton = new TowerShopButton();
